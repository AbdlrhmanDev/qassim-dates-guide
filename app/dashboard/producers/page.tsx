...
import ProducersAdminPage from "@/pages/dashboard/ProducersAdminPage";

export default function DashboardProducersPage() {
  ...
  return <DashboardLayout><ProducersAdminPage /></DashboardLayout>;
}
