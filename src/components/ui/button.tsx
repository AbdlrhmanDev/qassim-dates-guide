  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Hero button - for hero sections with glow effect
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-glow hover:shadow-elevated hover:-translate-y-1 font-semibold",
        // Accent button - palm green
        ...
        // Gold button - premium feel
        gold: "bg-gradient-to-r from-primary via-date-gold to-primary text-primary-foreground shadow-glow hover:shadow-elevated hover:-translate-y-0.5",
      },
      size: {
